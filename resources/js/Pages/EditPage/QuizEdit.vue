                   ...
                   <div class="container">
                       ...
                       <div style="height:20px;"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <button class="btn btn-info btn-block btn-lg" @click="openImage">تحديث الصورة</button>
                                    <div class="fileInput">
  ...
  export default {
    ...
    methods: {
        ...
        updateImage() {
            ...
            vm.show_loader = true;
                vm.error = false;
            axios.post('admin/quiz/updateImage/' + vm.$route.params.id,{image:vm.form.image}).then(response => {
                vm.show_loader = false;
                vm.error = false;
                confirm('تم تحديث الصورة بنجاح') &&
                location.reload();
            }).catch(err => {
                vm.show_loader = false;
                vm.error = true;
        ...
        update() {
            ...
            axios.post('admin/quiz/update/' + vm.$route.params.id , vm.form).then(response => {
                vm.show_loader = false;
                vm.error = false;
                confirm('تم التعديل بنجاح') && 
                location.reload();
            }).catch(err => {
                vm.show_loader = false;
                vm.error = true;
